...
// - m1: 002
Given('initially m1 active with {optionalString}', async ({ page }, a1) => {
...
// - m1: 001, 002
// - m3: 019
When('e1 with {optionalString}', async ({ page }, a1) => {
...
// - m1: 001, 002
// - m3: 019
Then('expect m1 active with {optionalString}', async ({ page }, a1) => {
